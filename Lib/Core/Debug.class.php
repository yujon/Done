...
namespace Done\Lib\Core;
	class Debug {
		...
		static function message(){
			echo '<div style="overflow:hidden;word-wrap:break-word;float:left;clear:both;text-align:left;font-size:11px;color:#888;width:95%;margin:10px;padding:10px;background:#F5F5F5;border:1px dotted #778855;z-index:100">';
